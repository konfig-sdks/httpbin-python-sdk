...
class BaseApi(api_client.Api):
    ...
    def _return_delayed_response_mapped_args(
        self,
        delay: ModelInt,
    ...
    async def _areturn_delayed_response_oapg(
        self,
    ...
    def _return_delayed_response_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class ReturnDelayedResponseRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def areturn_delayed_response(
        self,
        delay: ModelInt,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._return_delayed_response_mapped_args(
            delay=delay,
        )
        return await self._areturn_delayed_response_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def return_delayed_response(
        self,
        delay: ModelInt,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._return_delayed_response_oapg(
            path_params=args.path,
        )

class ReturnDelayedResponse(BaseApi):
    ...
    async def areturn_delayed_response(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.areturn_delayed_response(
            delay=delay,
            **kwargs,
        )
    ...
    def return_delayed_response(
        ...
        raw_response = self.raw.return_delayed_response(
            delay=delay,
        )
