...
class BaseApi(api_client.Api):
    ...
    def _delayed_response_delete_mapped_args(
        self,
        delay: ModelInt,
    ...
    async def _adelayed_response_delete_oapg(
        self,
    ...
    def _delayed_response_delete_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DelayedResponseDeleteRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelayed_response_delete(
        self,
        delay: ModelInt,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delayed_response_delete_mapped_args(
            delay=delay,
        )
        return await self._adelayed_response_delete_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def delayed_response_delete(
        self,
        delay: ModelInt,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._delayed_response_delete_oapg(
            path_params=args.path,
        )

class DelayedResponseDelete(BaseApi):
    ...
    async def adelayed_response_delete(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelayed_response_delete(
            delay=delay,
            **kwargs,
        )
    ...
    def delayed_response_delete(
        ...
        raw_response = self.raw.delayed_response_delete(
            delay=delay,
        )
