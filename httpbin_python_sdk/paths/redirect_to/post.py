...
class BaseApi(api_client.Api):
    ...
    def _to_given_url_post_mapped_args(
        self,
        url: str,
    ...
    async def _ato_given_url_post_oapg(
        self,
...
class ToGivenUrlPostRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ato_given_url_post(
        self,
        url: str,
        status_code: typing.Optional[ModelInt] = None,
        **kwargs,
        ...
        args = self._to_given_url_post_mapped_args(
            url=url,
            status_code=status_code,
        )
        return await self._ato_given_url_post_oapg(
            body=args.body,
            **kwargs,
        )
    
    def to_given_url_post(
        self,
        url: str,
        status_code: typing.Optional[ModelInt] = None,
    ) -> typing.Union[
        ...
        return self._to_given_url_post_oapg(
            body=args.body,
        )

class ToGivenUrlPost(BaseApi):
    ...
    async def ato_given_url_post(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.ato_given_url_post(
            url=url,
            status_code=status_code,
            **kwargs,
        )
    ...
    def to_given_url_post(
        ...
        raw_response = self.raw.to_given_url_post(
            url=url,
            status_code=status_code,
        )
