...
_status_code_to_response = {
    '100': _response_for_100,
    '200': _response_for_200,
    '300': _response_for_300,
...
class BaseApi(api_client.Api):
    ...
    def _return_random_code_4_mapped_args(
        self,
        codes: str,
    ...
    async def _areturn_random_code_4_oapg(
        self,
    ...
    def _return_random_code_4_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class ReturnRandomCode4Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def areturn_random_code_4(
        self,
        codes: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._return_random_code_4_mapped_args(
            codes=codes,
        )
        return await self._areturn_random_code_4_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def return_random_code_4(
        self,
        codes: str,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._return_random_code_4_oapg(
            path_params=args.path,
        )

class ReturnRandomCode4(BaseApi):
    ...
    async def areturn_random_code_4(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.areturn_random_code_4(
            codes=codes,
            **kwargs,
        )
    ...
    def return_random_code_4(
        ...
        raw_response = self.raw.return_random_code_4(
            codes=codes,
        )
