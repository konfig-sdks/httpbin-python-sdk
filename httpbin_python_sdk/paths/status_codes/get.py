...
class BaseApi(api_client.Api):
    ...
    def _return_random_code_mapped_args(
        self,
        codes: str,
    ...
    async def _areturn_random_code_oapg(
        self,
...
class ReturnRandomCodeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def areturn_random_code(
        self,
        codes: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._return_random_code_mapped_args(
            codes=codes,
        )
        return await self._areturn_random_code_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def return_random_code(
        self,
        codes: str,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._return_random_code_oapg(
            path_params=args.path,
        )

class ReturnRandomCode(BaseApi):
    ...
    async def areturn_random_code(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.areturn_random_code(
            codes=codes,
            **kwargs,
        )
    ...
    def return_random_code(
        ...
        raw_response = self.raw.return_random_code(
            codes=codes,
        )
