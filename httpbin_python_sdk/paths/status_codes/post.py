...
class BaseApi(api_client.Api):
    ...
    def _return_random_code_1_mapped_args(
        self,
        codes: str,
    ...
    async def _areturn_random_code_1_oapg(
        self,
    ...
    def _return_random_code_1_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class ReturnRandomCode1Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def areturn_random_code_1(
        self,
        codes: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._return_random_code_1_mapped_args(
            codes=codes,
        )
        return await self._areturn_random_code_1_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def return_random_code_1(
        self,
        codes: str,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._return_random_code_1_oapg(
            path_params=args.path,
        )

class ReturnRandomCode1(BaseApi):
    ...
    async def areturn_random_code_1(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.areturn_random_code_1(
            codes=codes,
            **kwargs,
        )
    ...
    def return_random_code_1(
        ...
        raw_response = self.raw.return_random_code_1(
            codes=codes,
        )
