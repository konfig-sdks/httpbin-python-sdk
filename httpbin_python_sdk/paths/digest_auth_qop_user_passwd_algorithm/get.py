...
class BaseApi(api_client.Api):
    ...
    def _user_authorization_digest_mapped_args(
        self,
        qop: str,
        user: str,
        passwd: str,
    ...
    async def _auser_authorization_digest_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/digest-auth/{qop}/{user}/{passwd}/{algorithm}',
            headers=_headers,
        )
    ...
    def _user_authorization_digest_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class UserAuthorizationDigestRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def auser_authorization_digest(
        self,
        qop: str,
        user: str,
        passwd: str,
        ...
        **kwargs,
        ...
        args = self._user_authorization_digest_mapped_args(
            qop=qop,
            user=user,
            passwd=passwd,
            algorithm=algorithm,
        )
        return await self._auser_authorization_digest_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def user_authorization_digest(
        self,
        qop: str,
        user: str,
        passwd: str,
        ...
        return self._user_authorization_digest_oapg(
            path_params=args.path,
        )

class UserAuthorizationDigest(BaseApi):
    ...
    async def auser_authorization_digest(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.auser_authorization_digest(
            qop=qop,
            user=user,
            passwd=passwd,
            algorithm=algorithm,
    ...
    def user_authorization_digest(
        ...
        raw_response = self.raw.user_authorization_digest(
            qop=qop,
            user=user,
            passwd=passwd,
            algorithm=algorithm,
