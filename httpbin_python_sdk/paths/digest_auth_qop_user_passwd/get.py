...
class BaseApi(api_client.Api):
    ...
    def _digest_auth_prompt_mapped_args(
        self,
        qop: str,
        user: str,
        passwd: str,
    ...
    async def _adigest_auth_prompt_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/digest-auth/{qop}/{user}/{passwd}',
            headers=_headers,
        )
...
class DigestAuthPromptRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adigest_auth_prompt(
        self,
        qop: str,
        user: str,
        passwd: str,
        **kwargs,
        ...
        args = self._digest_auth_prompt_mapped_args(
            qop=qop,
            user=user,
            passwd=passwd,
        )
        return await self._adigest_auth_prompt_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def digest_auth_prompt(
        self,
        qop: str,
        user: str,
        passwd: str,
        ...
        return self._digest_auth_prompt_oapg(
            path_params=args.path,
        )

class DigestAuthPrompt(BaseApi):
    ...
    async def adigest_auth_prompt(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adigest_auth_prompt(
            qop=qop,
            user=user,
            passwd=passwd,
            **kwargs,
    ...
    def digest_auth_prompt(
        ...
        raw_response = self.raw.digest_auth_prompt(
            qop=qop,
            user=user,
            passwd=passwd,
        )
