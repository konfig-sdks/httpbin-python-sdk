...
class BaseApi(api_client.Api):
    ...
    def _query_headers_get_mapped_args(
        self,
    ...
    async def _aquery_headers_get_oapg(
        self,
...
class QueryHeadersGetRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aquery_headers_get(
        self,
        freeform: typing.Optional[typing.Dict[str, str]] = None,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._query_headers_get_mapped_args(
            freeform=freeform,
        )
        return await self._aquery_headers_get_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def query_headers_get(
        self,
        freeform: typing.Optional[typing.Dict[str, str]] = None,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._query_headers_get_oapg(
            query_params=args.query,
        )

class QueryHeadersGet(BaseApi):
    ...
    async def aquery_headers_get(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aquery_headers_get(
            freeform=freeform,
            **kwargs,
        )
    ...
    def query_headers_get(
        ...
        raw_response = self.raw.query_headers_get(
            freeform=freeform,
        )
