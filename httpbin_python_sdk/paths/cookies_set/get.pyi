...
class SetRedirectRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aset_redirect(
        self,
        freeform: typing.Optional[typing.Dict[str, str]] = None,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._set_redirect_mapped_args(
            freeform=freeform,
        )
        return await self._aset_redirect_oapg(
    ...
    def set_redirect(
        ...
        return self._set_redirect_oapg(
            query_params=args.query,
        )

class SetRedirect(BaseApi):
    ...
    async def aset_redirect(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aset_redirect(
            freeform=freeform,
            **kwargs,
        )
    ...
    def set_redirect(
        ...
        raw_response = self.raw.set_redirect(
            freeform=freeform,
        )
